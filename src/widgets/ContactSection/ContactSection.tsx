...
function ContactSection() {
  return (
    <PageSection id="contact-section" classname="mt-32">
      <Typography variant="h2" className="relative z-10 w-[700px]">
        Свяжитесь с юристом нашей фирмы
      </Typography>
      <p className="text-2xl leading-8 mt-8 relative z-10">
      ...
      <AbsoulteContainer classname="inset-y-0 right-0 top-[30%]">
